export const messages = {
    ...
    try_mint_more: (value: string) => `You're trying to mint more than the maximum payout available! The maximum mint payout is ${value} UNREKT.`,
    ...
    before_claim_airdrop: "There are no claimable rewards available",

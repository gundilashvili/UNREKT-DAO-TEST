...
function BondRedeem({ bond }: IBondRedeem) {
    ...
    console.log("bondDetails.bondMaturationBlock", bondDetails.bondMaturationBlock);
    const vestingPeriod = () => {
            ...
            <Slide direction="right" in={true} mountOnEnter unmountOnExit {...{ timeout: 533 }}>
                <Box className="bond-data">
                    <div className="data-row">
                        ...
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.interestDue, 4)} UNREKT`}</p>
                    </div>
                    <div className="data-row">
                        <p className="bond-balance-title">Claimable Rewards</p>
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.pendingPayout, 4)} UNREKT`}</p>
                    </div>
                    <div className="data-row">
